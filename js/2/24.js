    ...
    var Tooth_24 = 1;
    var Furcation_24_dp = 0;
    var Furcation_24_mp = 0;
    var Implant_24 = 0;
    var BOP_24_db = 0;
    var BOP_24_b = 0;
    var BOP_24_mb = 0;
...
function clear_data_24() {
    if (Tooth_24 == 1) {
        ...
        Furcation_24_mp = 0;
            ...
            document.getElementById('furcation_1_24_dp').style.display = 'none';
            document.getElementById('furcation_2_24_dp').style.display = 'none';
            document.getElementById('furcation_3_24_dp').style.display = 'none';
                
            document.getElementById('furcation_1_24_dp_tab').style.display = 'none';
            document.getElementById('furcation_2_24_dp_tab').style.display = 'none';
            document.getElementById('furcation_3_24_dp_tab').style.display = 'none';
            
            document.getElementById('furcation_1_24_mp').style.display = 'none';
            document.getElementById('furcation_2_24_mp').style.display = 'none';
            document.getElementById('furcation_3_24_mp').style.display = 'none';
            
            document.getElementById('furcation_1_24_mp_tab').style.display = 'none';
            document.getElementById('furcation_2_24_mp_tab').style.display = 'none';
            document.getElementById('furcation_3_24_mp_tab').style.display = 'none';
...
function toggle_tooth_24() {
    if (Tooth_24 === 1) {
        ...
        document.getElementById('implant_24_btn').style.display = 'none';
        document.getElementById('implant_24_tab').style.display = 'none';
        document.getElementById('implant_24_b_image').style.display = 'none';
        document.getElementById('implant_24_p_image').style.display = 'none';
        
        document.getElementById('furcation_24_dp_btn').style.display = 'none';
        document.getElementById('furcation_24_mp_btn').style.display = 'none';
        ...
        document.getElementById('implant_24_btn').style.display = 'block';

        document.getElementById('furcation_24_dp_btn').style.display = 'block';
        document.getElementById('furcation_24_mp_btn').style.display = 'block';
        ...
        if (Furcation_24_dp == 1) {
            document.getElementById('furcation_1_24_dp').style.display = 'block';
        } else if (Furcation_24_dp == 2) {
            document.getElementById('furcation_2_24_dp').style.display = 'block';
        } else if (Furcation_24_dp == 3) {
            document.getElementById('furcation_3_24_dp').style.display = 'block';
        }
        if (Furcation_24_dp == 1) {
            document.getElementById('furcation_1_24_dp_tab').style.display = 'block';
        } else if (Furcation_24_dp == 2) {
            document.getElementById('furcation_2_24_dp_tab').style.display = 'block';
        } else if (Furcation_24_dp == 3) {
            document.getElementById('furcation_3_24_dp_tab').style.display = 'block';
        }
        if (Furcation_24_mp == 1) {
            document.getElementById('furcation_1_24_mp').style.display = 'block';
        } else if (Furcation_24_mp == 2) {
            document.getElementById('furcation_2_24_mp').style.display = 'block';
        } else if (Furcation_24_mp == 3) {
            document.getElementById('furcation_3_24_mp').style.display = 'block';
        }
        if (Furcation_24_mp == 1) {
            document.getElementById('furcation_1_24_mp_tab').style.display = 'block';
        } else if (Furcation_24_mp == 2) {
            document.getElementById('furcation_2_24_mp_tab').style.display = 'block';
        } else if (Furcation_24_mp == 3) {
            document.getElementById('furcation_3_24_mp_tab').style.display = 'block';
        }
        ...
        document.getElementById('implant_24_btn').style.display = 'block';
        document.getElementById('implant_24_tab').style.display = 'block';
        document.getElementById('implant_24_b_image').style.display = 'block';
        document.getElementById('implant_24_p_image').style.display = 'block';
...
function change_probing_24(probing_depth_min = 0) {
    if (Tooth_24 == 1) {
        
    // Variablen aus dem Formular
        st_24_db = document.forms[0]["st_24_db"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_24_db"].value - probing_depth_min;
        st_24_b = document.forms[0]["st_24_b"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_24_b"].value - probing_depth_min;
        st_24_mb = document.forms[0]["st_24_mb"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_24_mb"].value - probing_depth_min;

        if (document.forms[0]["st_24_dp"].value > probing_depth_min) {document.forms[0]["st_24_dp"].style.color = 'red';} else {document.forms[0]["st_24_dp"].style.color = 'black'};
        if (document.forms[0]["st_24_p"].value > probing_depth_min) {document.forms[0]["st_24_p"].style.color = 'red';} else {document.forms[0]["st_24_p"].style.color = 'black'};
        if (document.forms[0]["st_24_mp"].value > probing_depth_min) {document.forms[0]["st_24_mp"].style.color = 'red';} else {document.forms[0]["st_24_mp"].style.color = 'black'};
        
        mg_24_db = document.forms[0]["mg_24_db"].value;
        mg_24_b = document.forms[0]["mg_24_b"].value;
        mg_24_mb = document.forms[0]["mg_24_mb"].value;
        
        st_24_dp = document.forms[0]["st_24_dp"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_24_dp"].value - probing_depth_min;
        st_24_p = document.forms[0]["st_24_p"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_24_p"].value - probing_depth_min;
        st_24_mp = document.forms[0]["st_24_mp"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_24_mp"].value - probing_depth_min;

        if (document.forms[0]["st_24_db"].value > probing_depth_min) {document.forms[0]["st_24_db"].style.color = 'red';} else {document.forms[0]["st_24_db"].style.color = 'black'};
        if (document.forms[0]["st_24_b"].value > probing_depth_min) {document.forms[0]["st_24_b"].style.color = 'red';} else {document.forms[0]["st_24_b"].style.color = 'black'};
        if (document.forms[0]["st_24_mb"].value > probing_depth_min) {document.forms[0]["st_24_mb"].style.color = 'red';} else {document.forms[0]["st_24_mb"].style.color = 'black'};
