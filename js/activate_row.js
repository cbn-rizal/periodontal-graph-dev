// Activate or inactivate entire row
function activate_BOP_b_OK() {
    if (event.shiftKey) {
		if (Tooth_18 == 1) {
			BOP_18_db = 0;
			BOP_18_b = 0;
