    ...
    var Tooth_38 = 1;
    var Furcation_38_b = 0;
    var Furcation_38_l = 0;
    var Implant_38 = 0;
    var BOP_38_db = 0;
    var BOP_38_b = 0;
    var BOP_38_mb = 0;
...
function clear_data_38() {
    if (Tooth_38 == 1) {
        ...
        Furcation_38_l = 0;
            ...
            document.getElementById('furcation_1_38_b').style.display = 'none';
            document.getElementById('furcation_2_38_b').style.display = 'none';
            document.getElementById('furcation_3_38_b').style.display = 'none';
                
            document.getElementById('furcation_1_38_b_tab').style.display = 'none';
            document.getElementById('furcation_2_38_b_tab').style.display = 'none';
            document.getElementById('furcation_3_38_b_tab').style.display = 'none';
            
            document.getElementById('furcation_1_38_l').style.display = 'none';
            document.getElementById('furcation_2_38_l').style.display = 'none';
            document.getElementById('furcation_3_38_l').style.display = 'none';
                
            document.getElementById('furcation_1_38_l_tab').style.display = 'none';
            document.getElementById('furcation_2_38_l_tab').style.display = 'none';
            document.getElementById('furcation_3_38_l_tab').style.display = 'none';
...
function toggle_tooth_38() {
    if (Tooth_38 === 1) {
        ...
        document.getElementById('implant_38_btn').style.display = 'none';
        document.getElementById('implant_38_tab').style.display = 'none';
        document.getElementById('implant_38_b_image').style.display = 'none';
        document.getElementById('implant_38_l_image').style.display = 'none';
        
        document.getElementById('furcation_38_b_btn').style.display = 'none';
        document.getElementById('furcation_38_l_btn').style.display = 'none';
        ...
        document.getElementById('implant_38_btn').style.display = 'block';

        document.getElementById('furcation_38_b_btn').style.display = 'block';
        document.getElementById('furcation_38_l_btn').style.display = 'block';
        ...
        if (Furcation_38_b == 1) {
            document.getElementById('furcation_1_38_b').style.display = 'block';
        } else if (Furcation_38_b == 2) {
            document.getElementById('furcation_2_38_b').style.display = 'block';
        } else if (Furcation_38_b == 3) {
            document.getElementById('furcation_3_38_b').style.display = 'block';
        }
        if (Furcation_38_b == 1) {
            document.getElementById('furcation_1_38_b_tab').style.display = 'block';
        } else if (Furcation_38_b == 2) {
            document.getElementById('furcation_2_38_b_tab').style.display = 'block';
        } else if (Furcation_38_b == 3) {
            document.getElementById('furcation_3_38_b_tab').style.display = 'block';
        }
        if (Furcation_38_l == 1) {
            document.getElementById('furcation_1_38_l').style.display = 'block';
        } else if (Furcation_38_l == 2) {
            document.getElementById('furcation_2_38_l').style.display = 'block';
        } else if (Furcation_38_l == 3) {
            document.getElementById('furcation_3_38_l').style.display = 'block';
        }
        if (Furcation_38_l == 1) {
            document.getElementById('furcation_1_38_l_tab').style.display = 'block';
        } else if (Furcation_38_l == 2) {
            document.getElementById('furcation_2_38_l_tab').style.display = 'block';
        } else if (Furcation_38_l == 3) {
            document.getElementById('furcation_3_38_l_tab').style.display = 'block';
        }
        ...
        document.getElementById('implant_38_btn').style.display = 'block';
        document.getElementById('implant_38_tab').style.display = 'block';
        document.getElementById('implant_38_b_image').style.display = 'block';
        document.getElementById('implant_38_l_image').style.display = 'block';
...
function change_probing_38(probing_depth_min = 0) {
    if (Tooth_38 == 1) {
        
    // Variablen aus dem Formular
        st_38_db = document.forms[0]["st_38_db"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_38_db"].value - probing_depth_min;
        st_38_b = document.forms[0]["st_38_b"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_38_b"].value - probing_depth_min;
        st_38_mb = document.forms[0]["st_38_mb"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_38_mb"].value - probing_depth_min;

        if (document.forms[0]["st_38_dl"].value > probing_depth_min) {document.forms[0]["st_38_dl"].style.color = 'red';} else {document.forms[0]["st_38_dl"].style.color = 'black'};
        if (document.forms[0]["st_38_l"].value > probing_depth_min) {document.forms[0]["st_38_l"].style.color = 'red';} else {document.forms[0]["st_38_l"].style.color = 'black'};
        if (document.forms[0]["st_38_ml"].value > probing_depth_min) {document.forms[0]["st_38_ml"].style.color = 'red';} else {document.forms[0]["st_38_ml"].style.color = 'black'};
        
        mg_38_db = document.forms[0]["mg_38_db"].value;
        mg_38_b = document.forms[0]["mg_38_b"].value;
        mg_38_mb = document.forms[0]["mg_38_mb"].value;
        
        st_38_dl = document.forms[0]["st_38_dl"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_38_dl"].value - probing_depth_min;
        st_38_l = document.forms[0]["st_38_l"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_38_l"].value - probing_depth_min;
        st_38_ml = document.forms[0]["st_38_ml"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_38_ml"].value - probing_depth_min;

        if (document.forms[0]["st_38_db"].value > probing_depth_min) {document.forms[0]["st_38_db"].style.color = 'red';} else {document.forms[0]["st_38_db"].style.color = 'black'};
        if (document.forms[0]["st_38_b"].value > probing_depth_min) {document.forms[0]["st_38_b"].style.color = 'red';} else {document.forms[0]["st_38_b"].style.color = 'black'};
        if (document.forms[0]["st_38_mb"].value > probing_depth_min) {document.forms[0]["st_38_mb"].style.color = 'red';} else {document.forms[0]["st_38_mb"].style.color = 'black'};
