    ...
    var Tooth_36 = 1;
    var Furcation_36_b = 0;
    var Furcation_36_l = 0;
    var Implant_36 = 0;
    var BOP_36_db = 0;
    var BOP_36_b = 0;
    var BOP_36_mb = 0;
...
function clear_data_36() {
    if (Tooth_36 == 1) {
        ...
        Furcation_36_l = 0;
            ...
            document.getElementById('furcation_1_36_b').style.display = 'none';
            document.getElementById('furcation_2_36_b').style.display = 'none';
            document.getElementById('furcation_3_36_b').style.display = 'none';
                
            document.getElementById('furcation_1_36_b_tab').style.display = 'none';
            document.getElementById('furcation_2_36_b_tab').style.display = 'none';
            document.getElementById('furcation_3_36_b_tab').style.display = 'none';
            
            document.getElementById('furcation_1_36_l').style.display = 'none';
            document.getElementById('furcation_2_36_l').style.display = 'none';
            document.getElementById('furcation_3_36_l').style.display = 'none';
                
            document.getElementById('furcation_1_36_l_tab').style.display = 'none';
            document.getElementById('furcation_2_36_l_tab').style.display = 'none';
            document.getElementById('furcation_3_36_l_tab').style.display = 'none';
...
function toggle_tooth_36() {
    if (Tooth_36 === 1) {
        ...
        document.getElementById('implant_36_btn').style.display = 'none';
        document.getElementById('implant_36_tab').style.display = 'none';
        document.getElementById('implant_36_b_image').style.display = 'none';
        document.getElementById('implant_36_l_image').style.display = 'none';
        
        document.getElementById('furcation_36_b_btn').style.display = 'none';
        document.getElementById('furcation_36_l_btn').style.display = 'none';
        ...
        document.getElementById('implant_36_btn').style.display = 'block';

        document.getElementById('furcation_36_b_btn').style.display = 'block';
        document.getElementById('furcation_36_l_btn').style.display = 'block';
        ...
        if (Furcation_36_b == 1) {
            document.getElementById('furcation_1_36_b').style.display = 'block';
        } else if (Furcation_36_b == 2) {
            document.getElementById('furcation_2_36_b').style.display = 'block';
        } else if (Furcation_36_b == 3) {
            document.getElementById('furcation_3_36_b').style.display = 'block';
        }
        if (Furcation_36_b == 1) {
            document.getElementById('furcation_1_36_b_tab').style.display = 'block';
        } else if (Furcation_36_b == 2) {
            document.getElementById('furcation_2_36_b_tab').style.display = 'block';
        } else if (Furcation_36_b == 3) {
            document.getElementById('furcation_3_36_b_tab').style.display = 'block';
        }
        if (Furcation_36_l == 1) {
            document.getElementById('furcation_1_36_l').style.display = 'block';
        } else if (Furcation_36_l == 2) {
            document.getElementById('furcation_2_36_l').style.display = 'block';
        } else if (Furcation_36_l == 3) {
            document.getElementById('furcation_3_36_l').style.display = 'block';
        }
        if (Furcation_36_l == 1) {
            document.getElementById('furcation_1_36_l_tab').style.display = 'block';
        } else if (Furcation_36_l == 2) {
            document.getElementById('furcation_2_36_l_tab').style.display = 'block';
        } else if (Furcation_36_l == 3) {
            document.getElementById('furcation_3_36_l_tab').style.display = 'block';
        }
        ...
        document.getElementById('implant_36_btn').style.display = 'block';
        document.getElementById('implant_36_tab').style.display = 'block';
        document.getElementById('implant_36_b_image').style.display = 'block';
        document.getElementById('implant_36_l_image').style.display = 'block';
...
function change_probing_36(probing_depth_min = 0) {
    if (Tooth_36 == 1) {
        
    // Variablen aus dem Formular
        st_36_db = document.forms[0]["st_36_db"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_36_db"].value - probing_depth_min;
        st_36_b = document.forms[0]["st_36_b"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_36_b"].value - probing_depth_min;
        st_36_mb = document.forms[0]["st_36_mb"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_36_mb"].value - probing_depth_min;

        if (document.forms[0]["st_36_dl"].value > probing_depth_min) {document.forms[0]["st_36_dl"].style.color = 'red';} else {document.forms[0]["st_36_dl"].style.color = 'black'};
        if (document.forms[0]["st_36_l"].value > probing_depth_min) {document.forms[0]["st_36_l"].style.color = 'red';} else {document.forms[0]["st_36_l"].style.color = 'black'};
        if (document.forms[0]["st_36_ml"].value > probing_depth_min) {document.forms[0]["st_36_ml"].style.color = 'red';} else {document.forms[0]["st_36_ml"].style.color = 'black'};
        
        mg_36_db = document.forms[0]["mg_36_db"].value;
        mg_36_b = document.forms[0]["mg_36_b"].value;
        mg_36_mb = document.forms[0]["mg_36_mb"].value;
        
        st_36_dl = document.forms[0]["st_36_dl"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_36_dl"].value - probing_depth_min;
        st_36_l = document.forms[0]["st_36_l"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_36_l"].value - probing_depth_min;
        st_36_ml = document.forms[0]["st_36_ml"].value - probing_depth_min <= 0 ? 0 : document.forms[0]["st_36_ml"].value - probing_depth_min;

        if (document.forms[0]["st_36_db"].value > probing_depth_min) {document.forms[0]["st_36_db"].style.color = 'red';} else {document.forms[0]["st_36_db"].style.color = 'black'};
        if (document.forms[0]["st_36_b"].value > probing_depth_min) {document.forms[0]["st_36_b"].style.color = 'red';} else {document.forms[0]["st_36_b"].style.color = 'black'};
        if (document.forms[0]["st_36_mb"].value > probing_depth_min) {document.forms[0]["st_36_mb"].style.color = 'red';} else {document.forms[0]["st_36_mb"].style.color = 'black'};
